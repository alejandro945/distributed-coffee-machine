    ...
    stages {
        stage('Clone repository') {
            steps {
                ...
                sh 'sshpass -p "swarch" scp -o StrictHostKeyChecking=no -r --force $(pwd)/* swarch@10.147.19.125:./ci-cd-coffee-machine/'
                sh 'sshpass -p "swarch" scp -o StrictHostKeyChecking=no -r --force $(pwd)/* swarch@10.147.19.95:./ci-cd-coffee-machine/'
                sh 'sshpass -p "swarch" scp -o StrictHostKeyChecking=no -r --force $(pwd)/* swarch@10.147.19.107:./ci-cd-coffee-machine/'
            }
        }
