...
public interface ObservablePrx extends com.zeroc.Ice.ObjectPrx
{
    default boolean not()
    {
        return not(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean not(java.util.Map<String, String> context)
    {
        return _iceI_notAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> notAsync()
    {
        return _iceI_notAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> notAsync(java.util.Map<String, String> context)
    {
        return _iceI_notAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_notAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "not", null, sync, null);
